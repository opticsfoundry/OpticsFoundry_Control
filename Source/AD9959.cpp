...
CAD9959::CAD9959(unsigned short aBus, unsigned long aBaseAddress, double aExternalClockSpeed, double aFrequencyMultiplier, bool aAD9958, CMultiIO* aMyMultiIO)
