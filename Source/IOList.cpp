...
//AD9959DDS1
void SetFrequencyAD9959TestDDSCh0(double Frequency) {
	SetFrequencyCh0DDSAD9959(1, Frequency);
}

void SetIntensityAD9959TestDDSCh0(double Intensity) { //Intensity from 0 to 100%
	SetIntensityCh0DDSAD9959(1, Intensity);
}

void SetPhaseAD9959TestDDSCh0(double Phase) {
	SetPhaseCh0DDSAD9959(1, Phase);
}

void SetFrequencyAD9959TestDDSCh1(double Frequency) {
	SetFrequencyCh1DDSAD9959(1, Frequency);
}

void SetIntensityAD9959TestDDSCh1(double Intensity) {  //Intensity from 0 to 100%
	SetIntensityCh1DDSAD9959(1, Intensity);
}

void SetPhaseAD9959TestDDSCh1(double Phase) {
	SetPhaseCh1DDSAD9959(1, Phase);
}

void SetFrequencyAD9959TestDDSCh2(double Frequency) {
	SetFrequencyCh2DDSAD9959(1, Frequency);
}

void SetIntensityAD9959TestDDSCh2(double Intensity) {  //Intensity from 0 to 100%
	SetIntensityCh2DDSAD9959(1, Intensity);
}

void SetPhaseAD9959TestDDSCh2(double Phase) {
	SetPhaseCh2DDSAD9959(1, Phase);
}


void SetFrequencyAD9959TestDDSCh3(double Frequency) {
	SetFrequencyCh3DDSAD9959(1, Frequency);
}

void SetIntensityAD9959TestDDSCh3(double Intensity) {  //Intensity from 0 to 100%
	SetIntensityCh3DDSAD9959(1, Intensity);
}

void SetPhaseAD9959TestDDSCh3(double Phase) {
	SetPhaseCh3DDSAD9959(1, Phase);
}
