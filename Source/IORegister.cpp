...
double DDSAD9959AttenuationMax;
...
CIORegister::CIORegister()
{
	...
	if (!DDSAD9959Units) {
		DDSAD9959AttenuationMax = -31.75;
		DDSAD9959Units = new CString;
		DDSAD9959Units->Format("%.0f..0dB", DDSAD9959AttenuationMax);
	}
...
// DDS AD9959 functions

void SetIntensityCh0DDSAD9959(unsigned int DDSNumber, double Intensity) {
	Output->SetAD9959Value(DDSNumber, Intensity, Intensity, 0);
}

void SetAttenuationCh0DDSAD9959(unsigned int DDSNumber, double Attenuation) {
	Output->SetAD9959Value(DDSNumber, Attenuation, Attenuation, 1);
}

void SetFrequencyCh0DDSAD9959(unsigned int DDSNumber, double Frequency) {
	Output->SetAD9959Value(DDSNumber, Frequency, Frequency, 2);
}

void SetFrequencyTuningWordCh0DDSAD9959(unsigned int DDSNumber, double Frequency) {
	Output->SetAD9959Value(DDSNumber, Frequency, Frequency, 3);
}

void SetPhaseCh0DDSAD9959(unsigned int DDSNumber, double Phase) {
	Output->SetAD9959Value(DDSNumber, Phase, Phase, 4);
}


void SetIntensityCh1DDSAD9959(unsigned int DDSNumber, double Intensity) {
	Output->SetAD9959Value(DDSNumber, Intensity, Intensity, 5);
}

void SetAttenuationCh1DDSAD9959(unsigned int DDSNumber, double Attenuation) {
	Output->SetAD9959Value(DDSNumber, Attenuation, Attenuation, 6);
}

void SetFrequencyCh1DDSAD9959(unsigned int DDSNumber, double Frequency) {
	Output->SetAD9959Value(DDSNumber, Frequency, Frequency, 7);
}

void SetFrequencyTuningWordCh1DDSAD9959(unsigned int DDSNumber, double Frequency) {
	Output->SetAD9959Value(DDSNumber, Frequency, Frequency, 8);
}

void SetPhaseCh1DDSAD9959(unsigned int DDSNumber, double Phase) {
	Output->SetAD9959Value(DDSNumber, Phase, Phase, 9);
}



void SetIntensityCh2DDSAD9959(unsigned int DDSNumber, double Intensity) {
	Output->SetAD9959Value(DDSNumber, Intensity, Intensity, 10);
}

void SetAttenuationCh2DDSAD9959(unsigned int DDSNumber, double Attenuation) {
	Output->SetAD9959Value(DDSNumber, Attenuation, Attenuation, 11);
}

void SetFrequencyCh2DDSAD9959(unsigned int DDSNumber, double Frequency) {
	Output->SetAD9959Value(DDSNumber, Frequency, Frequency, 12);
}

void SetFrequencyTuningWordCh2DDSAD9959(unsigned int DDSNumber, double Frequency) {
	Output->SetAD9959Value(DDSNumber, Frequency, Frequency, 13);
}

void SetPhaseCh2DDSAD9959(unsigned int DDSNumber, double Phase) {
	Output->SetAD9959Value(DDSNumber, Phase, Phase, 14);
}


void SetIntensityCh3DDSAD9959(unsigned int DDSNumber, double Intensity) {
	Output->SetAD9959Value(DDSNumber, Intensity, Intensity, 15);
}

void SetAttenuationCh3DDSAD9959(unsigned int DDSNumber, double Attenuation) {
	Output->SetAD9959Value(DDSNumber, Attenuation, Attenuation, 16);
}

void SetFrequencyCh3DDSAD9959(unsigned int DDSNumber, double Frequency) {
	Output->SetAD9959Value(DDSNumber, Frequency, Frequency, 17);
}

void SetFrequencyTuningWordCh3DDSAD9959(unsigned int DDSNumber, double Frequency) {
	Output->SetAD9959Value(DDSNumber, Frequency, Frequency, 18);
}

void SetPhaseCh3DDSAD9959(unsigned int DDSNumber, double Phase) {
	Output->SetAD9959Value(DDSNumber, Phase, Phase, 19);
}

void ResetAD9959(unsigned int DDSNumber) {
	Output->SetAD9959Value(DDSNumber, 0, 0, 20);
}


void SyncIOAD9959(unsigned int DDSNumber) {
	Output->SetAD9959Value(DDSNumber, 0, 0, 21);
}

void SetIOUpdateEnabledAD9959(unsigned int DDSNumber, bool IOUpdateEnabled) {
	Output->SetAD9959Value(DDSNumber, (IOUpdateEnabled) ? 1 : 0, (IOUpdateEnabled) ? 1 : 0, 22);
}
