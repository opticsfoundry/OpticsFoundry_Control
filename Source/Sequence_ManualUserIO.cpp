...
double InitAQuRAAD9959TestDDSCh0Frequency;
double InitAQuRAAD9959TestDDSCh0Intensity;
//double InitAQuRAAD9959TestDDSCh0Phase;
double InitAQuRAAD9959TestDDSCh1Frequency;
double InitAQuRAAD9959TestDDSCh1Intensity;
double InitAQuRAAD9959TestDDSCh1Phase;
void CSequence::InitializeAQuRAAD9959DDS1() {
	if (AssemblingIOList()) {
		IOList->RegisterAnalogOutput(&SetFrequencyAD9959TestDDSCh0, "SetFrequencyAD9959TestDDSCh0", "AD9959 DDS1 Ch0 Frequency", "MHz", /*Help*/ "", /*Min*/ 0, /*Max*/ 225, /*Constant*/ false);
		IOList->RegisterAnalogOutput(&SetIntensityAD9959TestDDSCh0, "SetIntensityAD9959TestDDSCh0", "AD9959 DDS1 Ch0 Intensity", "0..100%", /*Help*/ "", /*Min*/ 0, /*Max*/ 100, /*Constant*/ false);
		//IOList->RegisterAnalogOutput(&SetPhaseAD9959TestDDSCh0, "SetPhaseAD9959TestDDSCh0", "AD9959 DDS1 Ch0 Phase", "0..360", /*Help*/ "", /*Min*/ 0, /*Max*/ 360, /*Constant*/ false);
		IOList->RegisterAnalogOutput(&SetFrequencyAD9959TestDDSCh1, "SetFrequencyAD9959TestDDSCh1", "AD9959 DDS1 Ch1 Frequency", "MHz", /*Help*/ "", /*Min*/ 0, /*Max*/ 225, /*Constant*/ false);
		IOList->RegisterAnalogOutput(&SetIntensityAD9959TestDDSCh1, "SetIntensityAD9959TestDDSCh1", "AD9959 DDS1 Ch1 Intensity", "0..100%", /*Help*/ "", /*Min*/ 0, /*Max*/ 100, /*Constant*/ false);
		IOList->RegisterAnalogOutput(&SetPhaseAD9959TestDDSCh1, "SetPhaseAD9959TestDDSCh1", "AD9959 DDS1 Ch1 Phase", "0..360", /*Help*/ "", /*Min*/ 0, /*Max*/ 360, /*Constant*/ false);
		IOList->AddStatic("");
	}
	else if (AssemblingParamList()) {
		ParamList->RegisterDouble(&InitAQuRAAD9959TestDDSCh0Frequency, "InitAQuRAAD9959TestDDSCh0Frequency", 0, 225, "AD9959 DDS1 Ch0 Frequency", "MHz");
		ParamList->RegisterDouble(&InitAQuRAAD9959TestDDSCh0Intensity, "InitAQuRAAD9959TestDDSCh0Intensity", 0, 100, "AD9959 DDS1 Ch0 Intensity", "0..100%");
		//ParamList->RegisterDouble(&InitAQuRAAD9959TestDDSCh0Phase, "InitAQuRAAD9959TestDDSCh0Phase", 0, 360, "AD9959 DDS1 Ch0 Phase", "0..360");
		ParamList->RegisterDouble(&InitAQuRAAD9959TestDDSCh1Frequency, "InitAQuRAAD9959TestDDSCh1Frequency", 0, 225, "AD9959 DDS1 Ch1 Frequency", "MHz");
		ParamList->RegisterDouble(&InitAQuRAAD9959TestDDSCh1Intensity, "InitAQuRAAD9959TestDDSCh1Intensity", 0, 100, "AD9959 DDS1 Ch1 Intensity", "0..100%");
		ParamList->RegisterDouble(&InitAQuRAAD9959TestDDSCh1Phase, "InitAQuRAAD9959TestDDSCh1Phase", 0, 360, "AD9959 DDS1 Ch1 Phase", "0..360");
		ParamList->AddStatic("");
	}
	else {
		SetFrequencyAD9959TestDDSCh0(InitAQuRAAD9959TestDDSCh0Frequency);
		SetIntensityAD9959TestDDSCh0(InitAQuRAAD9959TestDDSCh0Intensity);
		//SetPhaseAD9959TestDDSCh0(InitAQuRAAD9959TestDDSCh0Phase);
		SetFrequencyAD9959TestDDSCh1(InitAQuRAAD9959TestDDSCh1Frequency);
		SetIntensityAD9959TestDDSCh1(InitAQuRAAD9959TestDDSCh1Intensity);
		SetPhaseAD9959TestDDSCh1(InitAQuRAAD9959TestDDSCh1Phase);
	}
}
...
void CSequence::InitializeSystem(bool OnlyFastOutputs, bool HardResetSystem) {
	...
	CurrentList->NewMenu("AD9858, AD9959 DDS" + EndText);
	CurrentList->AddStatic("AD9959 DDS", "", ColorSrBlue);
	InitializeAQuRAAD9959DDS1();
#endif
...
{	
	...
	//Add the 9958 DDS
	/*AD9959[1] = */ MultiIO0->AddAD9959(/*Bus*/Bus0,/*BaseAddress*/20,/*Clockspeed [MHz]*/1000,/*FrequencyMultiplier*/ 1, /* AD9958 */false);
