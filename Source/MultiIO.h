...
const unsigned int MaxAD9959 = 256;
extern unsigned long NrAD9959;
extern CAD9959* AD9959[MaxAD9959];
extern unsigned long AD9959MultiWriteDeviceNr[MaxAD9959];
...
public:	
	...
	CAD9959* AddAD9959(unsigned short aBus, unsigned int aBaseAddress, double externalClockSpeed, double FrequencyMultiplier, bool AD9958);
