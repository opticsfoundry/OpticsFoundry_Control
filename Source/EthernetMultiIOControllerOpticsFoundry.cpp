...
*/
void CEthernetMultiIOControllerOpticsFoundry::AddCommandJumpForward(unsigned int jump_length, bool unconditional_jump, bool condition_0, bool condition_1, bool condition_PS, bool condition_dig_in, uint8_t dig_in_bit_nr) {
...
void CEthernetMultiIOControllerOpticsFoundry::AddCommandJumpBackward(unsigned int jump_length, bool unconditional_jump, bool condition_0, bool condition_1, bool condition_PS, bool condition_dig_in, uint8_t dig_in_bit_nr, bool loop_count_greater_zero) {
...
void CEthernetMultiIOControllerOpticsFoundry::SetTriggerOptions( unsigned __int32* buffer, unsigned __int32 n, bool ExternalTrigger0, bool ExternalTrigger1) {
	if (SetPeriodicTriggerAtBeginningOfNextSequence && (PeriodicTriggerPeriod_in_ms > 0)) {
		...
		//end
		unsigned __int64 PeriodicTriggerPeriod = floor(PeriodicTriggerPeriod_in_ms * FPGAClockFrequencyInHz / 1000);
		const unsigned char command_mask = 0x1F;  //5 bit
		...
		//end
		unsigned __int64 PeriodicTriggerAllowedWaitCycles = floor(PeriodicTriggerAllowedWait_in_ms * FPGAClockFrequencyInHz / 1000);
...
void CEthernetMultiIOControllerOpticsFoundry::SetPeriodicTrigger(double aPeriodicTriggerPeriod_in_ms, double aPeriodicTriggerAllowedWaitTime_in_ms) {
