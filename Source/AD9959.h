/*! \file  SPI_DDS_AD9959.h
    \brief Header for SPI DDS (Direct Digital Synthesis) interface.
    \author Anthony Marshall
    
    AD9959 Dual DDS Implemented.
*/

#if !defined(AFX_AD9959_H__7535CF4F_BE73_4A04_9C26_C9CCACDE910B__INCLUDED_)
#define AFX_AD9959_H__7535CF4F_BE73_4A04_9C26_C9CCACDE910B__INCLUDED_
...
public:
    CAD9959(unsigned short aBus, unsigned long aBaseAddress, double aExternalClockSpeed, double aFrequencyMultiplier, bool aAD9958, CMultiIO* aMyMultiIO);
