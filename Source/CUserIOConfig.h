...
class CUserIOItemAD9959 : public CUserIOItem
{
public:
	std::string Description;
	std::string Help;
	...
	double InitPowerCh1;
	double InitPhaseCh1;
	double InitFrequencyCh2;
	double InitPowerCh2;
	double InitPhaseCh2;
	double InitFrequencyCh3;
	double InitPowerCh3;
	double InitPhaseCh3;
	bool Hardreset;
	bool Softreset;
	...
	std::shared_ptr<std::vector<CalibTerm>> powerCalibrationTerms;
public:
	CUserIOItemAD9959(const json& user_io_item_json);
	virtual ~CUserIOItemAD9959() = default;
	virtual bool AssembleIOList();
	virtual bool AssembleParamList();
	virtual void Reset(bool OnlyFastOutputs, bool HardResetSystem);
	...
	void SetFrequencyTuningWordCh2(double Frequency);
	void SetPhaseCh2(double Phase);

	void SetIntensityCh3(double Intensity);
	void SetAttenuationCh3(double Attenuation);
	void SetFrequencyCh3(double Frequency);
	void SetFrequencyTuningWordCh3(double Frequency);
	void SetPhaseCh3(double Phase);
