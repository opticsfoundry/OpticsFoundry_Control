...
if __name__ == "__main__":
    ...
    builder.RegisterSequencer(IP="10.10.28.118", Port=57978, ClockFrequencyinMHz=100, BusFrequencyinMHz=2, DebugOn = False) #0.104 #90.108
