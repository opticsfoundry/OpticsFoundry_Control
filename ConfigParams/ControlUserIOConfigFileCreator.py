...
class UserIOConfigBuilder:
    ...
    def validate_against_hardware(self,  HardwareConfigFilename="ConfigParams\\ControlHardwareConfig.json"):
        ...
        for key, span in {"DDSAD9854Boards": 4, "DDSAD9858Boards": 4, "DDSAD9959Boards": 1}.items():
        ...
        for entry in self.config["UserIOConfiguration"]:
            if "Sequencer" in entry and "Address" in entry:
                ...
                if pair not in valid_pairs:
                    ...
                    board_channel_names= {"DDSAD9854Boards": "DDSAD9854", "DDSAD9858Boards": "DDSAD9858", "DDSAD9959Boards": "DDSAD9959",
...
if __name__ == "__main__":
    ...
    builder.add_new_menu(Text="AQuRA AD9858 and AD9959 DDS")
